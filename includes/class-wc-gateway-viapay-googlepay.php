...
class WC_Gateway_Viapay_Googlepay extends WC_Gateway_Viapay {
    /**
     * Logos
     * @var array
     */
    ...
    public function __construct() {
        $this->id           = 'viapay_googlepay';
        $this->has_fields   = true;
        $this->method_title = __( 'Viapay - Google Pay', 'viapay-checkout-gateway' );
    ...
    public function init_form_fields()
    {
        $this->form_fields = array(
            ...
            'title' => array(
                ...
                'default' => __('Viapay - Google Pay', 'viapay-checkout-gateway')
            ),
            'description' => array(
...
// Register Gateway
WC_ViapayCheckout::register_gateway( 'WC_Gateway_Viapay_Googlepay');