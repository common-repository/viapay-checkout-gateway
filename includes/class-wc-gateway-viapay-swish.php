...
class WC_Gateway_Viapay_Swish extends WC_Gateway_Viapay {
	/**
	 * Logos
	 * @var array
	 */
	...
	public function __construct() {
		$this->id           = 'viapay_swish';
		$this->has_fields   = true;
		$this->method_title = __( 'Viapay - Swish', 'viapay-checkout-gateway' );
		//$this->icon         = apply_filters( 'woocommerce_viapay_swish_icon', plugins_url( '/assets/images/swish.png', dirname( __FILE__ ) ) );
		$this->supports     = array(
			'products',
			'refunds',
		);
	...
	public function init_form_fields() {
		$this->form_fields = array(
			...
			'title'          => array(
				...
				'default'     => __( 'Viapay - Swish', 'viapay-checkout-gateway' )
			),
			'description'    => array(
...
// Register Gateway
WC_ViapayCheckout::register_gateway( 'WC_Gateway_Viapay_Swish' );
