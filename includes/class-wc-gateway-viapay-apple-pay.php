...
class WC_Gateway_Viapay_Apple_Pay extends WC_Gateway_Viapay {
	/**
	 * Logos
	 * @var array
	 */
	...
	public function __construct() {
		$this->id           = 'viapay_applepay';
		$this->has_fields   = true;
		$this->method_title = __( 'Viapay - Apple Pay', 'viapay-checkout-gateway' );
		//$this->icon         = apply_filters( 'woocommerce_viapay_applepay_icon', plugins_url( '/assets/images/applepay.png', dirname( __FILE__ ) ) );
		$this->supports     = array(
			'products',
			'refunds',
		);
	...
	public function init_form_fields() {
		$this->form_fields = array(
			...
			'title'          => array(
				...
				'default'     => __( 'Viapay - Apple Pay', 'viapay-checkout-gateway' )
			),
			'description'    => array(
...
// Register Gateway
WC_ViapayCheckout::register_gateway( 'WC_Gateway_Viapay_Apple_Pay');