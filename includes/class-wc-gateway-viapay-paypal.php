...
class WC_Gateway_Viapay_Paypal extends WC_Gateway_Viapay {
	/**
	 * Logos
	 * @var array
	 */
	...
	public function __construct() {
		$this->id           = 'viapay_paypal';
		$this->has_fields   = true;
		$this->method_title = __( 'Viapay - PayPal', 'viapay-checkout-gateway' );
		//$this->icon         = apply_filters( 'woocommerce_viapay_paypal_icon', plugins_url( '/assets/images/paypal.png', dirname( __FILE__ ) ) );
		$this->supports     = array(
			'products',
			'refunds',
		);
	...
	public function init_form_fields() {
		$this->form_fields = array(
			...
			'title'          => array(
				...
				'default'     => __( 'Viapay - PayPal', 'viapay-checkout-gateway' )
			),
			'description'    => array(
...
// Register Gateway
WC_ViapayCheckout::register_gateway( 'WC_Gateway_Viapay_Paypal' );
