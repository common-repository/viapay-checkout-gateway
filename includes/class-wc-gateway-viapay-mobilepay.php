...
class WC_Gateway_Viapay_Mobilepay extends WC_Gateway_Viapay {
	/**
	 * Logos
	 * @var array
	 */
	...
	public function __construct() {
		$this->id           = 'viapay_mobilepay';
		$this->has_fields   = true;
		$this->method_title = __( 'Viapay - Mobilepay', 'viapay-checkout-gateway' );
		//$this->icon         = apply_filters( 'woocommerce_viapay_mobilepay_icon', plugins_url( '/assets/images/mobilepay.png', dirname( __FILE__ ) ) );
		$this->supports     = array(
			'products',
			'refunds',
		);
	...
	public function init_form_fields() {
		$this->form_fields = array(
			...
			'title'          => array(
				...
				'default'     => __( 'Viapay - Mobilepay', 'viapay-checkout-gateway' )
			),
			'description'    => array(
...
// Register Gateway
WC_ViapayCheckout::register_gateway( 'WC_Gateway_Viapay_Mobilepay' );
