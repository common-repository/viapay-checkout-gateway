...
class WC_Gateway_Viapay_Vipps extends WC_Gateway_Viapay
{
    ...
    public function __construct() {
        $this->id           = 'viapay_vipps';
        $this->has_fields   = true;
        $this->method_title = __( 'Viapay - Vipps', 'viapay-checkout-gateway' );
    ...
    public function init_form_fields()
    {
        $this->form_fields = array(
            ...
            'title' => array(
                ...
                'default' => __('Viapay - Vipps', 'viapay-checkout-gateway')
            ),
            'description' => array(
...
// Register Gateway
WC_ViapayCheckout::register_gateway( 'WC_Gateway_Viapay_Vipps');
