...
class WC_Gateway_Viapay_Klarna_Pay_Now extends WC_Gateway_Viapay {
	/**
	 * Logos
	 * @var array
	 */
	...
	public function __construct() {
		$this->id           = 'viapay_klarna_pay_now';
		$this->has_fields   = true;
		$this->method_title = __( 'Viapay - Klarna Pay Now', 'viapay-checkout-gateway' );
		//$this->icon         = apply_filters( 'woocommerce_viapay_klarna_pn_icon', plugins_url( '/assets/images/klarna-pay-now.png', dirname( __FILE__ ) ) );
		$this->supports     = array(
			'products',
			'refunds',
		);
	...
	public function init_form_fields() {
		$this->form_fields = array(
			...
			'title'          => array(
				...
				'default'     => __( 'Viapay - Klarna Pay Now', 'viapay-checkout-gateway' )
			),
			'description'    => array(
...
// Register Gateway
WC_ViapayCheckout::register_gateway( 'WC_Gateway_Viapay_Klarna_Pay_Now' );
